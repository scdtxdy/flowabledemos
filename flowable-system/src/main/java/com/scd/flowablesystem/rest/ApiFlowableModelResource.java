...
import com.scd.flowablesystem.common.cmd.DeployModelCmd;
import com.scd.flowablesystem.common.cmd.SaveModelEditorCmd;
...
public class ApiFlowableModelResource {
  ...
  @Transactional(rollbackFor = Exception.class)
  public ReturnVo<String> deployModel(@RequestBody ModelRequest modelRequest) {
    ReturnVo<String> returnVo = new ReturnVo<>(ReturnCode.SUCCESS, "ok");
