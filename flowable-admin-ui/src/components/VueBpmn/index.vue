    ...
    <el-container class="fm2-container">
                ...
                <el-container class="center-container"
                    ...
                    <el-header class="btn-bar">
                        <el-button-group>
                            <el-button icon="el-icon-arrow-left"
                                       @click="handleUndo">撤回</el-button>
                            <el-button icon="el-icon-arrow-right"
                                       @click="handleRedo">重做</el-button>
                            <el-button icon="el-icon-circle-plus-outline"
                                       @click="handleZoom(0.2)">放大</el-button>
                            <el-button icon="el-icon-help"
                                       @click="handleZoom(0)">还原</el-button>
                            <el-button icon="el-icon-remove-outline"
                                       @click="handleZoom( - 0.2)">缩小</el-button>
                            <el-button icon="el-icon-upload2"
                                       @click="importXml">导入</el-button>
                            <el-upload action=""
                                       :before-upload="openBpmn"
                                       style="display: none">
                                <el-button ref="importBtn"
                                           size="mini"
                                           icon="el-icon-folder-opened"/>
                            </el-upload>
                            <el-button icon="el-icon-download"
                                       @click="handleExportXmlAction">XML</el-button>
                            <el-button icon="el-icon-download"
                                       @click="handleExportSvgAction">SVG
                            </el-button>
                            <el-button icon="el-icon-tickets"
                                       @click="handlePreviewXml">预览</el-button>
                    ...
                    <el-main>
                        <div class="containers"
                            ...
                            <div class="canvas"
                                 ref="canvas"/>
                            <el-dialog :visible.sync="xmlVisible"
                                       title="预览" fullscreen center>
                                ...
                                <span slot="footer">
                                    ...
                                    <el-button icon="el-icon-close"
                                               @click="xmlVisible = false">关闭</el-button>
                                </span>
                            </el-dialog>
                        </div>
                    </el-main>
        ...
        <el-footer height="30px"
            ...
            Powered by <a target="_blank"
                          href="https://github.com/scdtxdy/flowabledemos">flowabledemos</a>
        </el-footer>
    </el-container>
